    ...
    <div style={{ fontFamily: "system-ui, sans-serif", background: "#0a1a0f", color: "#fff", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <div style={{ minHeight: "100vh", background: "linear-gradient(160deg,#071210 0%,#0f2418 45%,#091824 100%)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", textAlign: "center", padding: "130px 24px 90px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", width: "100%", maxWidth: 580, marginBottom: 8 }}>
          <div style={{ position: "absolute", inset: "-20%", background: "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(15,50,20,0.95) 0%, rgba(7,18,8,0.98) 50%, transparent 100%)", borderRadius: "50%", zIndex: 0, pointerEvents: "none" }} />
          <img src="/logo-dark.jpg" alt="Accident Elves" style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 580, display: "block", margin: "0 auto", maskImage: "radial-gradient(ellipse 85% 88% at 50% 42%, black 45%, rgba(0,0,0,0.7) 65%, transparent 90%)", WebkitMaskImage: "radial-gradient(ellipse 85% 88% at 50% 42%, black 45%, rgba(0,0,0,0.7) 65%, transparent 90%)" }} />
          {/* Sparkle overlay */}
